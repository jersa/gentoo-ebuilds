...
SRC_URI="
	...
	$(cargo_crate_uris)
"
LICENSE="|| ( MIT ) || ( Apache-2.0 ) || ( Apache-2.0-with-LLVM-exceptions ) || ( Boost-1.0 ) || ( Unicode-DFS-2016 ) || ( Unlicense )
	MIT Apache-2.0 Apache-2.0-with-LLVM-exceptions Boost-1.0 Unicode-DFS-2016 Unlicense
"
SLOT="0"
KEYWORDS="~amd64 ~x86"
IUSE="doc"
...
src_prepare() {
	...
	#
	sed -i Cargo.toml -e 's/0.4.22/0.4.23/' || die
	default
}
